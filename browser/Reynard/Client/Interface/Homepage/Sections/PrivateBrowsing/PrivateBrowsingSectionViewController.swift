...
final class PrivateBrowsingSectionViewController: UIViewController {
    ...
    private let titleLabel: UILabel = {
        ...
        label.text = AppText.text("Private Browsing")
    ...
    private let messageLabel: UILabel = {
        ...
        label.text = AppText.text("After you close a tab, Reynard won't remember any of your browsing history or cookies. However, downloads and new bookmarks will be saved.")
        label.textAlignment = .center
