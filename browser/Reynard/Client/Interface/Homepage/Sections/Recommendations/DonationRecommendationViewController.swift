...
final class DonationRecommendationViewController: UIViewController, HomepageRecommendationViewController {
    ...
    private let messageLabel: UILabel = {
        ...
        label.text = NSLocalizedString("Hi, I'm Minh, the developer of Reynard. If you find the project useful, sponsoring me helps keep it alive and maintained. Thanks for the support!", comment: "")
        label.textAlignment = .left
