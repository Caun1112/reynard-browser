...
final class HistoryViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UIGestureRecognizerDelegate {
    ...
    private lazy var searchBar: UISearchBar = {
        ...
        searchBar.placeholder = AppText.text("Search History")
    ...
    private let emptyStateView = SidebarEmptyBackgroundView(message: AppText.text("Your browsing history appears here"))
    ...
    private func updateEmptyState() {
        ...
        emptyStateView.message = AppText.text(query.isEmpty ? "Your browsing history appears here" : "No matching history")
