...
struct PrivacySettingsSection {
    ...
    func cell(at index: Int) -> UITableViewCell {
        ...
        case .sitePermissions:
            return SettingsViewUtils.disclosureCell(title: AppText.text("Site Permissions"))
        case .clearBrowsingData:
            return SettingsViewUtils.disclosureCell(title: AppText.text("Clear Browsing Data"))
        }
    }
