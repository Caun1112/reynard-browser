...
final class SearchPreferencesViewController: SettingsTableViewController {
    private enum Section: CaseIterable {
        ...
        var text: SettingsSectionText {
            ...
            case .searchSuggestions:
                return SettingsSectionText(headerTitle: AppText.text("Search Suggestions"))
            }
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .searchEngine:
            ...
            cell.textLabel?.text = AppText.text("Search Engine")
        ...
        case .searchSuggestions:
            ...
            case .showSearchSuggestions:
                return switchCell(title: AppText.text("Show Search Suggestions"), accessoryView: showSearchSuggestionsSwitch)
            case .showInPrivateBrowsing:
                return switchCell(title: AppText.text("Show in Private Browsing"), accessoryView: showInPrivateBrowsingSwitch)
            case .searchBrowsingHistory:
                return switchCell(title: AppText.text("Search Browsing History"), accessoryView: searchBrowsingHistorySwitch)
            case .searchBookmarks:
                return switchCell(title: AppText.text("Search Bookmarks"), accessoryView: searchBookmarksSwitch)
            case .searchOpenedTabs:
                return switchCell(title: AppText.text("Search Opened Tabs"), accessoryView: searchOpenedTabsSwitch)
            case .searchSuggestionProvider:
                let cell = UITableViewCell(style: .value1, reuseIdentifier: nil)
                cell.textLabel?.text = AppText.text("Search Suggestion Provider")
