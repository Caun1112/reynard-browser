...
final class AppearancePreferencesViewController: SettingsTableViewController {
    private enum Section: CaseIterable {
        ...
        var text: SettingsSectionText {
            ...
            case .addressBar:
                return SettingsSectionText(headerTitle: AppText.text("Address Bar"))
            case .tabs:
                return SettingsSectionText(headerTitle: AppText.text("Tabs"))
            case .pageZoom:
                return SettingsSectionText(headerTitle: AppText.text("Page Zoom"))
            }
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .showFullWebsiteAddress:
            ...
            cell.textLabel?.text = AppText.text("Show Full Website Address")
            cell.selectionStyle = .none
            cell.accessoryView = showFullWebsiteAddressSwitch
            return cell
        case .landscapeTabBar:
            let cell = UITableViewCell(style: .default, reuseIdentifier: nil)
            cell.textLabel?.text = AppText.text("Landscape Tab Bar")
            cell.selectionStyle = .none
            cell.accessoryView = landscapeTabBarSwitch
            return cell
        case .pageZoom:
            let cell = UITableViewCell(style: .default, reuseIdentifier: nil)
            cell.textLabel?.text = AppText.text("Zoom Settings")
