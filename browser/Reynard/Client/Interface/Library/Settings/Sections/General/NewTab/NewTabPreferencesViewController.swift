...
final class NewTabPreferencesViewController: SettingsTableViewController, UITextFieldDelegate {
    private enum Section: CaseIterable {
        ...
        var text: SettingsSectionText {
            switch self {
            case .showOnNewTab:
                return SettingsSectionText(headerTitle: AppText.text("Show on New Tab"))
            }
        }
    }
    ...
    private enum Row: CaseIterable {
        ...
        var title: String {
            ...
            case .blankPage:
                return AppText.text("Blank Page")
            case .customURL:
                return AppText.text("Custom URL")
            }
        }
