...
final class AddressBar: UIView {
    ...
    private var menuToSecondaryConstraint: NSLayoutConstraint!
    ...
    private func configureConstraints() {
        ...
        secondaryTrailingButtonWidthConstraint = secondaryTrailingButton.widthAnchor.constraint(equalToConstant: RightHandLayout.isEnabled ? 44 : UX.addressBarButtonSize)
        ...
        menuToSecondaryConstraint = leadingButton.trailingAnchor.constraint(equalTo: secondaryTrailingButton.leadingAnchor, constant: -4)
    ...
    private func applyRenderModel(_ model: RenderModel) {
        ...
        if RightHandLayout.isEnabled {
            NSLayoutConstraint.activate([
                textLeadingToBackgroundConstraint,
                labelLeadingToBackgroundConstraint,
                showsLeadingButton ? textTrailingToMenuConstraint : (showsSecondaryTrailingButton ? textTrailingToSecondaryButtonConstraint : (showsTrailingButton ? textTrailingToButtonConstraint : textTrailingToBackgroundConstraint)),
                showsLeadingButton ? labelTrailingToMenuConstraint : (showsSecondaryTrailingButton ? labelTrailingToSecondaryButtonConstraint : (showsTrailingButton ? labelTrailingToButtonConstraint : labelTrailingToBackgroundConstraint)),
                showsSecondaryTrailingButton ? menuToSecondaryConstraint : (showsTrailingButton ? menuToReloadConstraint : menuToEdgeConstraint),
    ...
    private func applySecondaryTrailingButtonState(_ state: SecondaryTrailingButtonState) {
        ...
        if let image {
            secondaryTrailingButtonWidthConstraint.constant = max(
                RightHandLayout.isEnabled ? 44 : UX.addressBarButtonSize,
